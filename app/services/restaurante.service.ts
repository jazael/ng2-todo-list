...
export class RestauranteService{
  ...
  getRestauranteById(id:string, random = null){
    if(random == null){
  ...
  addRestaurante(restaurante:Restaurante){
    ...
    return this._http.post("http://localhost/api-rest/restaurantes-api.php/restaurantes", params, {headers:headers}).map(res => res.json());
  }
  ...
  editRestaurante(id:string, restaurante:Restaurante){
    ...
    return this._http.post("http://localhost/api-rest/restaurantes-api.php/update-restaurante/"+id, params, {headers:headers}).map(res => res.json());
  }
